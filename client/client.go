...
// NewClient returns the defaultClient
...
// Creates a new uncached client with the options passed in - one uses this if you need your Option's respected
func NewUncachedClient(opt ...Option) Client {
	return newRpcClient(opt...)
}
